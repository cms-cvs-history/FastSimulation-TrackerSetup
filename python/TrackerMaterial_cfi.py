...
#	107,  # Pixel endcap services
	...
	107,  # Pixel endcap services
	107,  # Pixel endcap services
        34,   # stack layer 5 (central gap)
        35,   # stack layer 6 (central gap)
        36,   # stack layer 7 (central gap)
        37,   # stack layer 8 (central gap)
	6,    # TIB1 services  
	7,    # TIB2 services  
	8,    # TIB3 services  
	9,    # TIB4 services  
...
#	 0.0,  # Pixel Wall 
	27.5,  # Pixel Wall   # was 29.0 before lb change
