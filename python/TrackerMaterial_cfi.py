...
TrackerMaterialBlock = cms.PSet(
    TrackerMaterial = cms.PSet(
        ...
        PXBStack7Thickness = cms.vdouble(0.0333, 0.03152, 0.03152), ## Assume 1.5 x Single Pixel Layer
         PXBStack8Thickness = cms.vdouble(0.0333, 0.03152, 0.03152), ## Assume 1.5 x Single Pixel Layer
         PXBStack9Thickness = cms.vdouble(0.0333, 0.03152, 0.03152), ## Assume 1.5 x Single Pixel Layer
         PXBStack10Thickness = cms.vdouble(0.0333, 0.03152, 0.03152), ## Assume 1.5 x Single Pixel Layer
        ...
        TOBLayer7Thickness = cms.vdouble(0.033, 0.022, 0.022), ## decrease by 30%
        TOBLayer8Thickness = cms.vdouble(0.033, 0.022, 0.022), ## decrease by 30%
        TOBLayer9Thickness = cms.vdouble(0.033, 0.022, 0.022), ## decrease by 30%
        TOBLayer10Thickness = cms.vdouble(0.033, 0.022, 0.022), ## decrease by 30%
        # TOB services (endcap)
